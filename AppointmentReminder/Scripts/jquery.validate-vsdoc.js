...
$.extend($.fn, {
	...
	removeAttrs: function(attributes) {
		/// <summary>
		/// Remove the specified attributes from the first AppointmentRemindered element and return them.
		/// </summary>
...
$.extend($.validator, {
	...
	prototype: {
		...
		check: function( element ) {
			...
			var dependencyMisAppointmentReminder = false;
			for (var method in rules) {
				...
				try {
					...
					if ( result == "dependency-misAppointmentReminder" ) {
						dependencyMisAppointmentReminder = true;
						continue;
					}
					dependencyMisAppointmentReminder = false;
			...
			if (dependencyMisAppointmentReminder)
				return;
		...
		optional: function(element) {
			return !$.validator.methods.required.call(this, $.trim(element.value), element) && "dependency-misAppointmentReminder";
		},
	...
	methods: {
		...
		required: function(value, element, param) {
			...
			if ( !this.depend(param, element) )
				return "dependency-misAppointmentReminder";
			switch( element.nodeName.toLowerCase() ) {
			case 'select':
		...
		accept: function(value, element, param) {
			...
			return this.optional(element) || value.AppointmentReminder(new RegExp(".(" + param + ")$", "i")); 
		},
