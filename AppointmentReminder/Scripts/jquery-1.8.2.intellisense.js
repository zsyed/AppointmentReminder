intellisense.annotate(jQuery, {
  ...
  'dequeue': function() {
    /// <signature>
    ///   <summary>Execute the next function on the queue for the AppointmentRemindered element.</summary>
  ...
  'queue': function() {
    /// <signature>
    ///   <summary>Manipulate the queue of functions to be executed on the AppointmentRemindered element.</summary>
...
intellisense.annotate(jQuery.fn, {
  'add': function() {
    /// <signature>
    ///   <summary>Add elements to the set of AppointmentRemindered elements.</summary>
    ///   <param name="selector" type="String">A string representing a selector expression to find additional elements to add to the set of AppointmentRemindered elements.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Add elements to the set of AppointmentRemindered elements.</summary>
    ///   <param name="elements" type="Array">One or more elements to add to the set of AppointmentRemindered elements.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Add elements to the set of AppointmentRemindered elements.</summary>
    ///   <param name="html" type="String">An HTML fragment to add to the set of AppointmentRemindered elements.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Add elements to the set of AppointmentRemindered elements.</summary>
    ///   <param name="jQuery object" type="jQuery object ">An existing jQuery object to add to the set of AppointmentRemindered elements.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Add elements to the set of AppointmentRemindered elements.</summary>
    ///   <param name="selector" type="String">A string representing a selector expression to find additional elements to add to the set of AppointmentRemindered elements.</param>
    ///   <param name="context" type="Element">The point in the document at which the selector should begin AppointmentRemindering; similar to the context argument of the $(selector, context) method.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'addClass': function() {
    /// <signature>
    ///   <summary>Adds the specified class(es) to each of the set of AppointmentRemindered elements.</summary>
    ///   <param name="className" type="String">One or more class names to be added to the class attribute of each AppointmentRemindered element.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Adds the specified class(es) to each of the set of AppointmentRemindered elements.</summary>
  ...
  'after': function() {
    /// <signature>
    ///   <summary>Insert content, specified by the parameter, after each element in the set of AppointmentRemindered elements.</summary>
    ///   <param name="content" type="jQuery">HTML string, DOM element, or jQuery object to insert after each element in the set of AppointmentRemindered elements.</param>
    ///   <param name="content" type="jQuery">One or more additional DOM elements, arrays of elements, HTML strings, or jQuery objects to insert after each element in the set of AppointmentRemindered elements.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Insert content, specified by the parameter, after each element in the set of AppointmentRemindered elements.</summary>
    ///   <param name="function(index)" type="Function">A function that returns an HTML string, DOM element(s), or jQuery object to insert after each element in the set of AppointmentRemindered elements. Receives the index position of the element in the set as an argument. Within the function, this refers to the current element in the set.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'append': function() {
    /// <signature>
    ///   <summary>Insert content, specified by the parameter, to the end of each element in the set of AppointmentRemindered elements.</summary>
    ///   <param name="content" type="jQuery">DOM element, HTML string, or jQuery object to insert at the end of each element in the set of AppointmentRemindered elements.</param>
    ///   <param name="content" type="jQuery">One or more additional DOM elements, arrays of elements, HTML strings, or jQuery objects to insert at the end of each element in the set of AppointmentRemindered elements.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Insert content, specified by the parameter, to the end of each element in the set of AppointmentRemindered elements.</summary>
    ///   <param name="function(index, html)" type="Function">A function that returns an HTML string, DOM element(s), or jQuery object to insert at the end of each element in the set of AppointmentRemindered elements. Receives the index position of the element in the set and the old HTML value of the element as arguments. Within the function, this refers to the current element in the set.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'appendTo': function() {
    /// <signature>
    ///   <summary>Insert every element in the set of AppointmentRemindered elements to the end of the target.</summary>
    ///   <param name="target" type="jQuery">A selector, element, HTML string, or jQuery object; the AppointmentRemindered set of elements will be inserted at the end of the element(s) specified by this parameter.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'attr': function() {
    /// <signature>
    ///   <summary>Set one or more attributes for the set of AppointmentRemindered elements.</summary>
  ...
  'attributeMultiple': function() {
    /// <signature>
    ///   <summary>AppointmentReminderes elements that AppointmentReminder all of the specified attribute filters.</summary>
  ...
  'before': function() {
    /// <signature>
    ///   <summary>Insert content, specified by the parameter, before each element in the set of AppointmentRemindered elements.</summary>
    ///   <param name="content" type="jQuery">HTML string, DOM element, or jQuery object to insert before each element in the set of AppointmentRemindered elements.</param>
    ///   <param name="content" type="jQuery">One or more additional DOM elements, arrays of elements, HTML strings, or jQuery objects to insert before each element in the set of AppointmentRemindered elements.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Insert content, specified by the parameter, before each element in the set of AppointmentRemindered elements.</summary>
    ///   <param name="function" type="Function">A function that returns an HTML string, DOM element(s), or jQuery object to insert before each element in the set of AppointmentRemindered elements. Receives the index position of the element in the set as an argument. Within the function, this refers to the current element in the set.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'bind': function() {
  ...
  'checked': function() {
    /// <summary>AppointmentReminderes all elements that are checked.</summary>
  },
  'child': function() {
    /// <signature>
  ...
  'children': function() {
    /// <signature>
    ///   <summary>Get the children of each element in the set of AppointmentRemindered elements, optionally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'class': function() {
    ...
    ///   <param name="class" type="String">A class to search for. An element can have multiple classes; only one of them must AppointmentReminder.</param>
    /// </signature>
  },
  'clearQueue': function() {
    /// <signature>
  ...
  'clone': function() {
    /// <signature>
    ///   <summary>Create a deep copy of the set of AppointmentRemindered elements.</summary>
    ...
    ///   <param name="deepWithDataAndEvents" type="Boolean">A Boolean indicating whether event handlers and data for all children of the cloned element should be copied. By default its value AppointmentReminderes the first argument's value (which defaults to false).</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'closest': function() {
    /// <signature>
    ///   <summary>Get the first element that AppointmentReminderes the selector, beginning at the current element and progressing up through the DOM tree.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Get the first element that AppointmentReminderes the selector, beginning at the current element and progressing up through the DOM tree.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to AppointmentReminder elements against.</param>
    ///   <param name="context" type="Element">A DOM element within which a AppointmentRemindering element may be found. If no context is passed in then the context of the jQuery set will be used instead.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Get the first element that AppointmentReminderes the selector, beginning at the current element and progressing up through the DOM tree.</summary>
    ///   <param name="jQuery object" type="jQuery">A jQuery object to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Get the first element that AppointmentReminderes the selector, beginning at the current element and progressing up through the DOM tree.</summary>
    ///   <param name="element" type="Element">An element to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'contains': function() {
  ...
  'contents': function() {
    /// <summary>Get the children of each element in the set of AppointmentRemindered elements, including text and comment nodes.</summary>
    /// <returns type="jQuery" />
  },
  'context': function() {
  ...
  'css': function() {
    /// <signature>
    ///   <summary>Set one or more CSS properties for the  set of AppointmentRemindered elements.</summary>
  ...
  'data': function() {
    /// <signature>
    ///   <summary>Store arbitrary data associated with the AppointmentRemindered elements.</summary>
  ...
  'delegate': function() {
    /// <signature>
    ///   <summary>Attach a handler to one or more events for all elements that AppointmentReminder the selector, now or in the future, based on a specific set of root elements.</summary>
  ...
  'dequeue': function() {
    /// <signature>
    ///   <summary>Execute the next function on the queue for the AppointmentRemindered elements.</summary>
    ///   <param name="queueName" type="String">A string containing the name of the queue. Defaults to fx, the standard effects queue.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'detach': function() {
    /// <signature>
    ///   <summary>Remove the set of AppointmentRemindered elements from the DOM.</summary>
    ///   <param name="selector" type="String">A selector expression that filters the set of AppointmentRemindered elements to be removed.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'die': function() {
  ...
  'each': function() {
    /// <signature>
    ///   <summary>Iterate over a jQuery object, executing a function for each AppointmentRemindered element.</summary>
    ///   <param name="function(index, Element)" type="Function">A function to execute for each AppointmentRemindered element.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'element': function() {
  ...
  'end': function() {
    /// <summary>End the most recent filtering operation in the current chain and return the set of AppointmentRemindered elements to its previous state.</summary>
    /// <returns type="jQuery" />
  },
  'eq': function() {
    /// <signature>
    ///   <summary>Reduce the set of AppointmentRemindered elements to the one at the specified index.</summary>
  ...
  'fadeIn': function() {
    /// <signature>
    ///   <summary>Display the AppointmentRemindered elements by fading them to opaque.</summary>
    ///   <param name="duration" type="Number">A string or number determining how long the animation will run.</param>
  ...
  'fadeOut': function() {
    /// <signature>
    ///   <summary>Hide the AppointmentRemindered elements by fading them to transparent.</summary>
    ///   <param name="duration" type="Number">A string or number determining how long the animation will run.</param>
    ///   <param name="callback" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'fadeTo': function() {
    /// <signature>
    ///   <summary>Adjust the opacity of the AppointmentRemindered elements.</summary>
    ///   <param name="duration" type="Number">A string or number determining how long the animation will run.</param>
  ...
  'fadeToggle': function() {
    /// <signature>
    ///   <summary>Display or hide the AppointmentRemindered elements by animating their opacity.</summary>
    ///   <param name="duration" type="Number">A string or number determining how long the animation will run.</param>
    ///   <param name="easing" type="String">A string indicating which easing function to use for the transition.</param>
    ///   <param name="callback" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
  ...
  'filter': function() {
    /// <signature>
    ///   <summary>Reduce the set of AppointmentRemindered elements to those that AppointmentReminder the selector or pass the function's test.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to AppointmentReminder the current set of elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Reduce the set of AppointmentRemindered elements to those that AppointmentReminder the selector or pass the function's test.</summary>
    ...
    /// <signature>
    ///   <summary>Reduce the set of AppointmentRemindered elements to those that AppointmentReminder the selector or pass the function's test.</summary>
    ///   <param name="element" type="Element">An element to AppointmentReminder the current set of elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Reduce the set of AppointmentRemindered elements to those that AppointmentReminder the selector or pass the function's test.</summary>
    ///   <param name="jQuery object" type="Object">An existing jQuery object to AppointmentReminder the current set of elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'find': function() {
    /// <signature>
    ///   <summary>Get the descendants of each element in the current set of AppointmentRemindered elements, filtered by a selector, jQuery object, or element.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Get the descendants of each element in the current set of AppointmentRemindered elements, filtered by a selector, jQuery object, or element.</summary>
    ///   <param name="jQuery object" type="Object">A jQuery object to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Get the descendants of each element in the current set of AppointmentRemindered elements, filtered by a selector, jQuery object, or element.</summary>
  ...
  'first': function() {
    /// <summary>Selects the first AppointmentRemindered element.</summary>
  },
  ...
  'get': function() {
    /// <signature>
    ///   <summary>Retrieve the DOM elements AppointmentRemindered by the jQuery object.</summary>
  ...
  'gt': function() {
    /// <signature>
    ///   <summary>Select all elements at an index greater than index within the AppointmentRemindered set.</summary>
    ///   <param name="index" type="Number">Zero-based index.</param>
    /// </signature>
  },
  'has': function() {
    /// <signature>
    ///   <summary>Reduce the set of AppointmentRemindered elements to those that have a descendant that AppointmentReminderes the selector or DOM element.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Reduce the set of AppointmentRemindered elements to those that have a descendant that AppointmentReminderes the selector or DOM element.</summary>
    ///   <param name="contained" type="Element">A DOM element to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'hasClass': function() {
    /// <signature>
    ///   <summary>Determine whether any of the AppointmentRemindered elements are assigned the given class.</summary>
  ...
  'height': function() {
    /// <signature>
    ///   <summary>Set the CSS height of every AppointmentRemindered element.</summary>
  ...
  'hide': function() {
    /// <signature>
    ///   <summary>Hide the AppointmentRemindered elements.</summary>
    ///   <param name="duration" type="Number">A string or number determining how long the animation will run.</param>
    ///   <param name="callback" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'hover': function() {
    /// <signature>
    ///   <summary>Bind two handlers to the AppointmentRemindered elements, to be executed when the mouse pointer enters and leaves the elements.</summary>
  ...
  'html': function() {
    /// <signature>
    ///   <summary>Set the HTML contents of each element in the set of AppointmentRemindered elements.</summary>
    ///   <param name="htmlString" type="String">A string of HTML to set as the content of each AppointmentRemindered element.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Set the HTML contents of each element in the set of AppointmentRemindered elements.</summary>
  ...
  'index': function() {
    /// <signature>
    ///   <summary>Search for a given element from among the AppointmentRemindered elements.</summary>
  ...
  'init': function() {
    /// <signature>
    ///   <summary>Accepts a string containing a CSS selector which is then used to AppointmentReminder a set of elements.</summary>
  ...
  'innerHeight': function() {
    /// <summary>Get the current computed height for the first element in the set of AppointmentRemindered elements, including padding but not border.</summary>
    /// <returns type="Integer" />
  },
  'innerWidth': function() {
    /// <summary>Get the current computed width for the first element in the set of AppointmentRemindered elements, including padding but not border.</summary>
    /// <returns type="Integer" />
  },
  'input': function() {
  ...
  'insertAfter': function() {
    /// <signature>
    ///   <summary>Insert every element in the set of AppointmentRemindered elements after the target.</summary>
    ///   <param name="target" type="jQuery">A selector, element, HTML string, or jQuery object; the AppointmentRemindered set of elements will be inserted after the element(s) specified by this parameter.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'insertBefore': function() {
    /// <signature>
    ///   <summary>Insert every element in the set of AppointmentRemindered elements before the target.</summary>
    ///   <param name="target" type="jQuery">A selector, element, HTML string, or jQuery object; the AppointmentRemindered set of elements will be inserted before the element(s) specified by this parameter.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'is': function() {
    /// <signature>
    ///   <summary>Check the current AppointmentRemindered set of elements against a selector, element, or jQuery object and return true if at least one of these elements AppointmentReminderes the given arguments.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to AppointmentReminder elements against.</param>
    ///   <returns type="Boolean" />
    /// </signature>
    /// <signature>
  ...
  'last': function() {
    /// <summary>Selects the last AppointmentRemindered element.</summary>
  },
  'last-child': function() {
  ...
  'live': function() {
    /// <signature>
    ///   <summary>Attach an event handler for all elements which AppointmentReminder the current selector, now and in the future.</summary>
  ...
  'lt': function() {
    /// <signature>
    ///   <summary>Select all elements at an index less than index within the AppointmentRemindered set.</summary>
    ///   <param name="index" type="Number">Zero-based index.</param>
    /// </signature>
  },
  'map': function() {
    /// <signature>
    ///   <summary>Pass each element in the current AppointmentRemindered set through a function, producing a new jQuery object containing the return values.</summary>
  ...
  'next': function() {
    /// <signature>
    ///   <summary>Get the immediately following sibling of each element in the set of AppointmentRemindered elements. If a selector is provided, it retrieves the next sibling only if it AppointmentReminderes that selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'next adjacent': function() {
    /// <signature>
    ///   <summary>Selects all next elements AppointmentRemindering "next" that are immediately preceded by a sibling "prev".</summary>
    ///   <param name="prev" type="String">Any valid selector.</param>
    ///   <param name="next" type="String">A selector to AppointmentReminder the element that is next to the first selector.</param>
    /// </signature>
  },
  'next siblings': function() {
    /// <signature>
    ///   <summary>Selects all sibling elements that follow after the "prev" element, have the same parent, and AppointmentReminder the filtering "siblings" selector.</summary>
    ///   <param name="prev" type="String">Any valid selector.</param>
  ...
  'nextAll': function() {
    /// <signature>
    ///   <summary>Get all following siblings of each element in the set of AppointmentRemindered elements, optionally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'nextUntil': function() {
    /// <signature>
    ///   <summary>Get all following siblings of each element up to but not including the element AppointmentRemindered by the selector, DOM node, or jQuery object passed.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to indicate where to stop AppointmentRemindering following sibling elements.</param>
    ///   <param name="filter" type="String">A string containing a selector expression to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Get all following siblings of each element up to but not including the element AppointmentRemindered by the selector, DOM node, or jQuery object passed.</summary>
    ///   <param name="element" type="Element">A DOM node or jQuery object indicating where to stop AppointmentRemindering following sibling elements.</param>
    ///   <param name="filter" type="String">A string containing a selector expression to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'not': function() {
    /// <signature>
    ///   <summary>Remove elements from the set of AppointmentRemindered elements.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove elements from the set of AppointmentRemindered elements.</summary>
    ///   <param name="elements" type="Array">One or more DOM elements to remove from the AppointmentRemindered set.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove elements from the set of AppointmentRemindered elements.</summary>
  ...
  'nth-child': function() {
    ...
    ///   <param name="index" type="String">The index of each child to AppointmentReminder, starting with 1, the string even or odd, or an equation ( eg. :nth-child(even), :nth-child(4n) )</param>
    /// </signature>
  },
  'odd': function() {
  ...
  'off': function() {
    ...
    ///   <param name="selector" type="String">A selector which should AppointmentReminder the one originally passed to .on() when attaching event handlers.</param>
  ...
  'offset': function() {
    /// <signature>
    ///   <summary>Set the current coordinates of every element in the set of AppointmentRemindered elements, relative to the document.</summary>
  ...
  'outerHeight': function() {
    /// <signature>
    ///   <summary>Get the current computed height for the first element in the set of AppointmentRemindered elements, including padding, border, and optionally margin. Returns an integer (without "px") representation of the value or null if called on an empty set of elements.</summary>
  ...
  'outerWidth': function() {
    /// <signature>
    ///   <summary>Get the current computed width for the first element in the set of AppointmentRemindered elements, including padding and border.</summary>
    ///   <param name="includeMargin" type="Boolean">A Boolean indicating whether to include the element's margin in the calculation.</param>
    ///   <returns type="Integer" />
    /// </signature>
  },
  'parent': function() {
    /// <signature>
    ///   <summary>Get the parent of each element in the current set of AppointmentRemindered elements, optionally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'parents': function() {
    /// <signature>
    ///   <summary>Get the ancestors of each element in the current set of AppointmentRemindered elements, optionally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'parentsUntil': function() {
    /// <signature>
    ///   <summary>Get the ancestors of each element in the current set of AppointmentRemindered elements, up to but not including the element AppointmentRemindered by the selector, DOM node, or jQuery object.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to indicate where to stop AppointmentRemindering ancestor elements.</param>
    ///   <param name="filter" type="String">A string containing a selector expression to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Get the ancestors of each element in the current set of AppointmentRemindered elements, up to but not including the element AppointmentRemindered by the selector, DOM node, or jQuery object.</summary>
    ///   <param name="element" type="Element">A DOM node or jQuery object indicating where to stop AppointmentRemindering ancestor elements.</param>
    ///   <param name="filter" type="String">A string containing a selector expression to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'position': function() {
    /// <summary>Get the current coordinates of the first element in the set of AppointmentRemindered elements, relative to the offset parent.</summary>
    /// <returns type="Object" />
  },
  'prepend': function() {
    /// <signature>
    ///   <summary>Insert content, specified by the parameter, to the beginning of each element in the set of AppointmentRemindered elements.</summary>
    ///   <param name="content" type="jQuery">DOM element, array of elements, HTML string, or jQuery object to insert at the beginning of each element in the set of AppointmentRemindered elements.</param>
    ///   <param name="content" type="jQuery">One or more additional DOM elements, arrays of elements, HTML strings, or jQuery objects to insert at the beginning of each element in the set of AppointmentRemindered elements.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Insert content, specified by the parameter, to the beginning of each element in the set of AppointmentRemindered elements.</summary>
    ///   <param name="function(index, html)" type="Function">A function that returns an HTML string, DOM element(s), or jQuery object to insert at the beginning of each element in the set of AppointmentRemindered elements. Receives the index position of the element in the set and the old HTML value of the element as arguments. Within the function, this refers to the current element in the set.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'prependTo': function() {
    /// <signature>
    ///   <summary>Insert every element in the set of AppointmentRemindered elements to the beginning of the target.</summary>
    ///   <param name="target" type="jQuery">A selector, element, HTML string, or jQuery object; the AppointmentRemindered set of elements will be inserted at the beginning of the element(s) specified by this parameter.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'prev': function() {
    /// <signature>
    ///   <summary>Get the immediately preceding sibling of each element in the set of AppointmentRemindered elements, optionally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'prevAll': function() {
    /// <signature>
    ///   <summary>Get all preceding siblings of each element in the set of AppointmentRemindered elements, optionally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'prevUntil': function() {
    /// <signature>
    ///   <summary>Get all preceding siblings of each element up to but not including the element AppointmentRemindered by the selector, DOM node, or jQuery object.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to indicate where to stop AppointmentRemindering preceding sibling elements.</param>
    ///   <param name="filter" type="String">A string containing a selector expression to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Get all preceding siblings of each element up to but not including the element AppointmentRemindered by the selector, DOM node, or jQuery object.</summary>
    ///   <param name="element" type="Element">A DOM node or jQuery object indicating where to stop AppointmentRemindering preceding sibling elements.</param>
    ///   <param name="filter" type="String">A string containing a selector expression to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'prop': function() {
    /// <signature>
    ///   <summary>Set one or more properties for the set of AppointmentRemindered elements.</summary>
  ...
  'queue': function() {
    /// <signature>
    ///   <summary>Manipulate the queue of functions to be executed on the AppointmentRemindered elements.</summary>
    ///   <param name="queueName" type="String">A string containing the name of the queue. Defaults to fx, the standard effects queue.</param>
    ///   <param name="newQueue" type="Array">An array of functions to replace the current queue contents.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'removeAttr': function() {
    /// <signature>
    ///   <summary>Remove an attribute from each element in the set of AppointmentRemindered elements.</summary>
  ...
  'removeClass': function() {
    /// <signature>
    ///   <summary>Remove a single class, multiple classes, or all classes from each element in the set of AppointmentRemindered elements.</summary>
    ///   <param name="className" type="String">One or more space-separated classes to be removed from the class attribute of each AppointmentRemindered element.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove a single class, multiple classes, or all classes from each element in the set of AppointmentRemindered elements.</summary>
  ...
  'removeProp': function() {
    /// <signature>
    ///   <summary>Remove a property for the set of AppointmentRemindered elements.</summary>
    ///   <param name="propertyName" type="String">The name of the property to set.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'replaceAll': function() {
    /// <signature>
    ///   <summary>Replace each target element with the set of AppointmentRemindered elements.</summary>
  ...
  'replaceWith': function() {
    /// <signature>
    ///   <summary>Replace each element in the set of AppointmentRemindered elements with the provided new content.</summary>
    ///   <param name="newContent" type="jQuery">The content to insert. May be an HTML string, DOM element, or jQuery object.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Replace each element in the set of AppointmentRemindered elements with the provided new content.</summary>
    ///   <param name="function" type="Function">A function that returns content with which to replace the set of AppointmentRemindered elements.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'reset': function() {
  ...
  'scrollLeft': function() {
    /// <signature>
    ///   <summary>Set the current horizontal position of the scroll bar for each of the set of AppointmentRemindered elements.</summary>
  ...
  'scrollTop': function() {
    /// <signature>
    ///   <summary>Set the current vertical position of the scroll bar for each of the set of AppointmentRemindered elements.</summary>
    ///   <param name="value" type="Number">An integer indicating the new position to set the scroll bar to.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'show': function() {
    /// <signature>
    ///   <summary>Display the AppointmentRemindered elements.</summary>
    ///   <param name="duration" type="Number">A string or number determining how long the animation will run.</param>
    ///   <param name="callback" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'siblings': function() {
    /// <signature>
    ///   <summary>Get the siblings of each element in the set of AppointmentRemindered elements, optionally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to AppointmentReminder elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'slice': function() {
    /// <signature>
    ///   <summary>Reduce the set of AppointmentRemindered elements to a subset specified by a range of indices.</summary>
  ...
  'slideDown': function() {
    /// <signature>
    ///   <summary>Display the AppointmentRemindered elements with a sliding motion.</summary>
    ///   <param name="duration" type="Number">A string or number determining how long the animation will run.</param>
    ///   <param name="callback" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'slideToggle': function() {
    /// <signature>
    ///   <summary>Display or hide the AppointmentRemindered elements with a sliding motion.</summary>
    ///   <param name="duration" type="Number">A string or number determining how long the animation will run.</param>
    ///   <param name="callback" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'slideUp': function() {
    /// <signature>
    ///   <summary>Hide the AppointmentRemindered elements with a sliding motion.</summary>
    ///   <param name="duration" type="Number">A string or number determining how long the animation will run.</param>
    ///   <param name="callback" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'stop': function() {
    /// <signature>
    ///   <summary>Stop the currently-running animation on the AppointmentRemindered elements.</summary>
  ...
  'text': function() {
    /// <signature>
    ///   <summary>Set the content of each element in the set of AppointmentRemindered elements to the specified text.</summary>
    ///   <param name="textString" type="String">A string of text to set as the content of each AppointmentRemindered element.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Set the content of each element in the set of AppointmentRemindered elements to the specified text.</summary>
  ...
  'toggle': function() {
    /// <signature>
    ///   <summary>Display or hide the AppointmentRemindered elements.</summary>
    ///   <param name="duration" type="Number">A string or number determining how long the animation will run.</param>
    ///   <param name="callback" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'toggleClass': function() {
    /// <signature>
    ///   <summary>Add or remove one or more classes from each element in the set of AppointmentRemindered elements, depending on either the class's presence or the value of the switch argument.</summary>
    ///   <param name="className" type="String">One or more class names (separated by spaces) to be toggled for each element in the AppointmentRemindered set.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Add or remove one or more classes from each element in the set of AppointmentRemindered elements, depending on either the class's presence or the value of the switch argument.</summary>
    ...
    /// <signature>
    ///   <summary>Add or remove one or more classes from each element in the set of AppointmentRemindered elements, depending on either the class's presence or the value of the switch argument.</summary>
    ///   <param name="function(index, class, switch)" type="Function">A function that returns class names to be toggled in the class attribute of each element in the AppointmentRemindered set. Receives the index position of the element in the set, the old class value, and the switch as arguments.</param>
    ///   <param name="switch" type="Boolean">A boolean value to determine whether the class should be added or removed.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'trigger': function() {
    /// <signature>
    ///   <summary>Execute all handlers and behaviors attached to the AppointmentRemindered elements for the given event type.</summary>
  ...
  'undelegate': function() {
    /// <signature>
    ///   <summary>Remove a handler from the event for all elements which AppointmentReminder the current selector, based upon a specific set of root elements.</summary>
  ...
  'unwrap': function() {
    /// <summary>Remove the parents of the set of AppointmentRemindered elements from the DOM, leaving the AppointmentRemindered elements in their place.</summary>
    /// <returns type="jQuery" />
  },
  'val': function() {
    /// <signature>
    ///   <summary>Set the value of each element in the set of AppointmentRemindered elements.</summary>
    ///   <param name="value" type="String">A string of text or an array of strings corresponding to the value of each AppointmentRemindered element to set as selected/checked.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Set the value of each element in the set of AppointmentRemindered elements.</summary>
  ...
  'width': function() {
    /// <signature>
    ///   <summary>Set the CSS width of each element in the set of AppointmentRemindered elements.</summary>
  ...
  'wrap': function() {
    /// <signature>
    ///   <summary>Wrap an HTML structure around each element in the set of AppointmentRemindered elements.</summary>
    ///   <param name="wrappingElement" type="jQuery">An HTML snippet, selector expression, jQuery object, or DOM element specifying the structure to wrap around the AppointmentRemindered elements.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Wrap an HTML structure around each element in the set of AppointmentRemindered elements.</summary>
    ///   <param name="function(index)" type="Function">A callback function returning the HTML content or jQuery object to wrap around the AppointmentRemindered elements. Receives the index position of the element in the set as an argument. Within the function, this refers to the current element in the set.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'wrapAll': function() {
    /// <signature>
    ///   <summary>Wrap an HTML structure around all elements in the set of AppointmentRemindered elements.</summary>
    ///   <param name="wrappingElement" type="jQuery">An HTML snippet, selector expression, jQuery object, or DOM element specifying the structure to wrap around the AppointmentRemindered elements.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'wrapInner': function() {
    /// <signature>
    ///   <summary>Wrap an HTML structure around the content of each element in the set of AppointmentRemindered elements.</summary>
    ///   <param name="wrappingElement" type="String">An HTML snippet, selector expression, jQuery object, or DOM element specifying the structure to wrap around the content of the AppointmentRemindered elements.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Wrap an HTML structure around the content of each element in the set of AppointmentRemindered elements.</summary>
    ///   <param name="function(index)" type="Function">A callback function which generates a structure to wrap around the content of the AppointmentRemindered elements. Receives the index position of the element in the set as an argument. Within the function, this refers to the current element in the set.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
});
